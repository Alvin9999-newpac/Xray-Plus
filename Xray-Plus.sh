...
rand_domain() {
  python3 -c "import random; d=['www.apple.com','www.microsoft.com','www.bing.com','www.yahoo.com','www.amazon.com','www.swift.org','www.adobe.com','www.cloudflare.com']; print(random.choice(d))"
}
...
do_install() {
  ...
  local PATH1 PATH2 PATH4 PATH5 PATH6
